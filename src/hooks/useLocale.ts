...
const ENGLISH_TEXT = new Map<string, string>([
  ...
  ['输入 GitHub 仓库链接，自动探测仓库内全部技能并按需安装', 'Paste a GitHub repository link to detect every skill inside and install what you need'],
  ...
  ['填写任意公开或私有 Git 仓库，系统将自动探测仓库内包含 SKILL.md 的全部技能并支持自动更新检测。', 'Enter any public or private Git repository. The app detects every skill containing SKILL.md inside and checks them for updates.'],
  ['GitHub 仓库路径 (owner/repo 或 HTTPS URL)', 'GitHub repository path (owner/repo or HTTPS URL)'],
  ['例如: anthropics/skills 或 https://github.com/my-org/agent-tools', 'For example: anthropics/skills or https://github.com/my-org/agent-tools'],
  ['Git 分支 (Branch)', 'Git branch'],
  ['技能子目录 (可选)', 'Skill subdirectory (optional)'],
  ['留空自动探测整个仓库，如: skills/pdf', 'Leave empty to detect the whole repository, e.g. skills/pdf'],
  ['正在探测仓库技能...', 'Detecting repository skills...'],
  ['探测仓库技能', 'Detect skills'],
  ['仓库探测失败：', 'Repository detection failed: '],
  ['未在 ', 'No skills with SKILL.md were found in '],
  ['（分支 ', ' (branch '],
  ['）中找到包含 SKILL.md 的技能目录，请确认仓库内容或改用上方「技能子目录」直接指定安装路径。', '). Confirm the repository content, or install a specific path via the skill subdirectory field above.'],
  ['在 ', 'Found '],
  ['）中发现 ', ') contains '],
  ['（仓库根目录）', '(repository root)'],
  ['一键安装所有技能 (', 'Install all skills ('],
  ['（其中 ', ' ('],
  [' 个未安装）', ' not installed)'],
  ['（全部已安装）', ' (all installed)'],
  ['无需安装', 'Nothing to install'],
  ['该仓库中所有技能均已安装。', 'All skills in this repository are already installed.'],
  ['分享链接中的所有技能均已安装。', 'All skills in this share link are already installed.'],
  ['安装', 'Install'],
  ...
  ['核心心智模型', 'Core concept'],
  ['所有安装或导入的技能集中存放于您指定的本地技能仓库目录中，统一分发至各个终端 AI 编程工具，免去冗余复制。', 'All installed or imported skills live in your chosen local library and are distributed to AI coding tools, avoiding redundant copies.'],
  ['配置技能仓库物理路径', 'Configure skill library location'],
  ['设置技能包的统一本地存储目录，后续可随时在设置中修改。', 'Set the local storage directory for skills. You can change it later in Settings.'],
  ['技能仓库物理存储路径:', 'Skill library location:'],
